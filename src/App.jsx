  ...
  return (
    <div className='navbar bg-gradient-to-r from-violet-500 to-fuchsia-500 w-full flex justify-between px-[12vw] py-4 items-center'>
      ...
      <div className='relative'>
        <button onClick={()=> setshow(false)} className='flex justify-center items-center border-2 p-2 rounded-full border-sky-500 text-3xl'> <FaShoppingCart/> </button>
